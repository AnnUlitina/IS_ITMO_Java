...
dependencies {
    implementation(project(mapOf("path" to ":koticki:service")))
    implementation(project(mapOf("path" to ":koticki:dal")))
    implementation(project(mapOf("path" to ":koticki:controller")))
